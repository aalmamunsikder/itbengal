...
export default function Testimonials() {
  ...
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto border border-slate-100 bg-white text-slate-800 rounded-3xl mt-12 mb-16 relative shadow-xl">
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="space-y-6">
            {reviews.map((item, idx) => (
              <div key={idx} className="border border-slate-200 rounded-xl p-4 bg-slate-55 relative">
