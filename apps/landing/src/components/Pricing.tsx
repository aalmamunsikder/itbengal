...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="py-24 px-6 max-w-7xl mx-auto border border-slate-100 bg-slate-50 text-slate-800 rounded-3xl mt-12 mb-16 relative">
      <div className="text-center mb-16 relative">
        <span className="text-[#0052cc] text-sm font-bold uppercase tracking-wider">Pricing Options</span>
