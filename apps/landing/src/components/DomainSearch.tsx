...
export default function DomainSearch() {
  ...
  return (
    <section id="domains" className="py-20 px-6 max-w-7xl mx-auto border-t border-slate-100 bg-white text-slate-800 rounded-3xl shadow-xl mt-12 mb-16 relative">
      <div className="text-center mb-12">
        ...
        <p className="text-slate-500 max-w-xl mx-auto text-sm md:text-base">
          Bind your branding with premium custom domain extensions instantly. Automated wildcard routing included free.
        </p>
      </div>
      ...
      <div className="mx-auto max-w-3xl bg-slate-50 border border-slate-200 rounded-2xl p-2.5 flex items-center shadow-md mb-8">
        ...
        <Link
          ...
          className="bg-primaryBlue hover:bg-blue-700 text-white font-bold px-8 py-3.5 rounded-xl text-sm md:text-base transition-all shadow-md active:scale-[0.98] flex items-center gap-2"
        >
