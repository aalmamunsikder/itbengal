...
export default function Hero() {
  ...
  return (
    <section className="relative w-full bg-gradient-to-r from-[#003ba3] via-[#002266] to-[#010821] py-20 lg:py-28 px-6 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl grid gap-16 lg:grid-cols-2 items-center relative z-10">
        {/* Left Column: Content */}
        <div className="space-y-8 text-left">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-400/20 bg-blue-950/40 text-xs font-bold text-blue-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-2">
            <Link
              ...
              className="px-8 py-4 rounded-lg text-base font-bold text-white bg-primaryBlue hover:bg-blue-700 shadow-lg hover:shadow-blue-500/20 transition-all duration-300 flex items-center justify-center gap-2"
            >
              Get Started Now
