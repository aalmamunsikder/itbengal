...
export default function Features() {
  ...
  return (
    <div className="w-full bg-white py-24 text-slate-800 space-y-36">
      ...
      <section className="max-w-7xl mx-auto px-6 grid gap-16 lg:grid-cols-2 items-center">
        ...
        <div className="relative flex justify-center">
          <div className="absolute inset-0 bg-blue-100/50 blur-3xl rounded-full pointer-events-none" />
          <div className="relative rounded-3xl border border-slate-200 bg-slate-50 p-8 w-full max-w-md shadow-lg flex flex-col items-center">
            {/* Center Node */}
            <div className="h-20 w-20 rounded-full bg-[#0052cc] flex items-center justify-center text-white shadow-xl text-3xl font-extrabold select-none animate-pulse-soft">
              H
            </div>
            {/* Surrounding floating nodes */}
            <div className="grid grid-cols-3 gap-6 mt-8 w-full">
              {['Git Repo', 'ZIP Uploader', 'PHP Server', 'Apache', 'MySQL DB', 'Nginx'].map((label, idx) => (
                <div key={idx} className="border border-slate-200 rounded-xl p-2 bg-white text-center text-xs font-bold text-slate-600 shadow-sm">
                  {label}
                </div>
              ))}
            </div>
        ...
        <div className="space-y-8">
          <span className="text-[#0052cc] text-sm font-bold uppercase tracking-wider">Zero Downtime Migration</span>
          ...
          <div className="pt-2">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-[#0052cc] hover:bg-blue-600 text-white font-bold px-6 py-3 rounded-lg text-sm transition-all shadow-md"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 grid gap-16 lg:grid-cols-2 items-center">
        ...
        <div className="space-y-8">
          <span className="text-[#0052cc] text-sm font-bold uppercase tracking-wider">Optimized Speed Engine</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 leading-tight">
            Lightning Fast <br />
            Loading Speed
          </h2>
        ...
        <div className="relative flex justify-center">
          ...
          <div className="relative rounded-3xl border border-slate-200 bg-slate-50 p-8 w-full max-w-md shadow-lg flex flex-col items-center">
            {/* Center Node */}
            <div className="h-20 w-20 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-700 shadow-md text-3xl font-extrabold select-none mb-6">
              ⚙️
            </div>
            {/* Round Badge Grid */}
            <div className="grid grid-cols-2 gap-4 w-full">
              {tools.map((tool, idx) => (
                <div key={idx} className="flex items-center gap-2 border border-slate-200 rounded-xl p-3 bg-white shadow-sm font-bold text-sm text-slate-700">
      ...
      <section className="max-w-7xl mx-auto px-6 grid gap-16 lg:grid-cols-2 items-center">
        ...
        <div className="space-y-8">
          <span className="text-[#0052cc] text-sm font-bold uppercase tracking-wider">Dashboard Portal</span>
          <h2 className="text-3xl md:text-5xl font-extrabold text-slate-900 leading-tight">
            User-Friendly <br />
            Control Panel
          </h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={idx} className="border-l-4 border-[#0052cc] pl-4 space-y-1">
        ...
        <div className="relative flex justify-center">
          <div className="absolute inset-0 bg-blue-100/50 blur-3xl rounded-full pointer-events-none" />
          <div className="relative w-full max-w-lg rounded-2xl border border-slate-200 bg-slate-50 p-2 shadow-xl overflow-hidden group">
            <div className="rounded-xl border border-slate-200 overflow-hidden bg-slate-950 p-4 text-left">
              {/* Header circles */}
              ...
              <div className="space-y-3 font-mono text-xs text-slate-400">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div className="border border-slate-800 rounded p-2 text-center bg-slate-900">
