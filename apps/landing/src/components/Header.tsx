  ...
  return (
    <div className="w-full z-50 relative">
      ...
      <div className="w-full bg-[#facc15] py-2.5 px-6 text-center text-xs md:text-sm font-bold text-slate-950 flex items-center justify-center gap-2 select-none">
        ...
        <Link href="#pricing" className="underline hover:text-slate-850 flex items-center gap-0.5 ml-1">
      ...
      <header className="w-full bg-white border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <Link href="https://dashboard.itbengal.xyz/login" className="text-sm font-bold text-slate-600 hover:text-primaryBlue transition-colors">
              Client Portal
            </Link>
            <Link
