    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4 py-8 animate-fade-in-up">
        ...
        <div className="mb-8 text-center">
          ...
          <div className="mx-auto mt-1 w-fit rounded-full border border-warning-500/30 bg-warning-500/10 px-3 py-0.5 text-xs font-medium text-warning-400">
            Admin Portal
          </div>
        </div>
