    ...
    <div className="space-y-6 animate-fade-in p-6 max-w-6xl mx-auto">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-xl border border-slate-100 dark:border-gray-800 bg-white dark:bg-gray-900/50 px-4 py-2.5 text-sm font-semibold text-gray-700 dark:text-gray-200 hover:bg-gray-55 dark:hover:bg-gray-800 transition-all"
        >
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {sites.map((site) => {
            ...
            return (
              <div
                key={site.id}
                className="rounded-2xl border border-slate-100 dark:border-gray-800 bg-white dark:bg-gray-900/40 p-6 flex flex-col justify-between"
              >
                {/* Site Header */}
                <div>
